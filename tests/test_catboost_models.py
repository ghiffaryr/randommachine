"""
Tests for CatBoost-based models.
"""
...
from randommachine.catboost_models import (
    RCBM,
...
class TestRandomCatBoostRegressor:
    """Test cases for RandomCatBoostRegressor."""
...
class TestRandomCatBoostClassifier:
    """Test cases for RandomCatBoostClassifier."""
    ...
    def test_initialization(self):
        """Test model initialization."""
        model = RandomCatBoostClassifier(
            loss=LogisticLoss,
            num_iterations=5,
            learning_rate=0.3,
            min_max_depth=3,
